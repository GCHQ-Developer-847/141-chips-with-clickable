...
<Canvas>
  <Story name="Clickable as link">
    {html`<ic-chip label="Label" clickable="true" href="/">
        <svg
          slot="icon"
          width="20"
          height="20"
      ...
      <ic-chip label="Label" clickable="true" href="/" appearance="outline">
        <svg
          slot="icon"
          width="20"
          height="20"
...
<Canvas>
  <Story name="Clickable as button">
    {html`<ic-chip label="Label" clickable="true" onclick="alert('clicked')">
        <svg
          slot="icon"
          width="20"
          height="20"
